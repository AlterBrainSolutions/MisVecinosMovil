...
public class Transparencia2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = findViewById(R.id.button2Back);
        btn2 = findViewById(R.id.button2Forw);
        /*buttont = findViewById(R.id.buttonDetalleTrn2);*/
        barChart = findViewById(R.id.pcBar2Transex);
        layoutList = findViewById(R.id.layout_list2);
        tvTotalIngresos = findViewById(R.id.tvTotalIngresos2);
        tvIngresoNeto = findViewById(R.id.tvIngresoNeto2);
        tvCasasCantidad = findViewById(R.id.tvCasasCantidad2);
        tvIngresosAntes = findViewById(R.id.tvIngresosAntes2);
        tvSaldoMesAnterior = findViewById(R.id.tvSaldoMesAnterior2);
        tvResiduosMes = findViewById(R.id.tvIngresoReciclaje2);

        mQueue = Volley.newRequestQueue(Transparencia2Activity.this);
        jsonParse2();
                        ...
                        try {
                            ...
                            for (int i = 0; i < tamRes2; i++) {
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent i = new Intent(Transparencia2Activity.this, MuestraFotoTransparencia.class);
