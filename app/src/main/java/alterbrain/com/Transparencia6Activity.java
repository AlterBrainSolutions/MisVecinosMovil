...
public class Transparencia6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = findViewById(R.id.button6Back);
        btn2 = findViewById(R.id.button6Forw);
        /*buttont = findViewById(R.id.buttonDetalleTrn6);*/
        barChart = findViewById(R.id.pcBar6Transex);
        layoutList = findViewById(R.id.layout_list6);
        tvTotalIngresos = findViewById(R.id.tvTotalIngresos6);
        tvIngresoNeto = findViewById(R.id.tvIngresoNeto6);
        tvCasasCantidad = findViewById(R.id.tvCasasCantidad6);
        tvIngresosAntes = findViewById(R.id.tvIngresosAntes6);
        tvSaldoMesAnterior = findViewById(R.id.tvSaldoMesAnterior6);
        tvResiduosMes = findViewById(R.id.tvIngresoReciclaje6);

        mQueue = Volley.newRequestQueue(Transparencia6Activity.this);
        jsonParse2();
                        ...
                        try {
                            ...
                            for (int i = 0; i < tamRes2; i++) {
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent i = new Intent(Transparencia6Activity.this, MuestraFotoTransparencia.class);
