...
public class Transparencia7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSaldoMesAnterior = findViewById(R.id.tvSaldoMesAnterior7);
        tvResiduosMes = findViewById(R.id.tvIngresoReciclaje7);
                        ...
                        try {
                            ...
                            for (int i = 0; i < tamRes2; i++) {
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent i = new Intent(Transparencia7Activity.this, MuestraFotoTransparencia.class);
