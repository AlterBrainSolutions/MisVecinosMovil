...
public class Transparencia3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barChart = findViewById(R.id.pcBar3Transex);
        ...
        tvCasasCantidad = findViewById(R.id.tvCasasCantidad3);
        tvIngresosAntes = findViewById(R.id.tvIngresosAntes3);
        tvSaldoMesAnterior = findViewById(R.id.tvSaldoMesAnterior3);
        tvResiduosMes = findViewById(R.id.tvIngresoReciclaje3);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < tamRes2; i++) {
                                ...
                                /*Toast.makeText(Transparencia3Activity.this,link_fracc, Toast.LENGTH_SHORT).show();*/
                                button.setText(link_fracc + mailparams.trim());

                                button.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent i = new Intent(Transparencia3Activity.this, MuestraFotoTransparencia.class);
                            ...
                            barEgresos.add(new BarEntry(contGrafica, auxTotal));//CAMBIO
                            contGrafica++;
