...
public class Transparencia4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = findViewById(R.id.button4Back);
        btn2 = findViewById(R.id.button4Forw);
        /*buttont = findViewById(R.id.buttonDetalleTrn4);*/
        barChart = findViewById(R.id.pcBar4Transex);
        layoutList = findViewById(R.id.layout_list4);
        tvTotalIngresos = findViewById(R.id.tvTotalIngresos4);
        tvIngresoNeto = findViewById(R.id.tvIngresoNeto4);
        tvCasasCantidad = findViewById(R.id.tvCasasCantidad4);
        tvIngresosAntes = findViewById(R.id.tvIngresosAntes4);
        tvSaldoMesAnterior = findViewById(R.id.tvSaldoMesAnterior4);
        tvResiduosMes = findViewById(R.id.tvIngresoReciclaje4);

        mQueue = Volley.newRequestQueue(Transparencia4Activity.this);
        jsonParse2();
                        ...
                        try {
                            ...
                            for (int i = 0; i < tamRes2; i++) {
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent i = new Intent(Transparencia4Activity.this, MuestraFotoTransparencia.class);
