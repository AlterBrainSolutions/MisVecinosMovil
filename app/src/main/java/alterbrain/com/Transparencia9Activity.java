...
public class Transparencia9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transparencia9);

        btn1 = findViewById(R.id.button9Back);
        btn2 = findViewById(R.id.button9Forw);
        /*buttont = findViewById(R.id.buttonDetalleTrn9);*/
        barChart = findViewById(R.id.pcBar9Transex);
        layoutList = findViewById(R.id.layout_list9);
        tvTotalIngresos = findViewById(R.id.tvTotalIngresos9);
        tvIngresoNeto = findViewById(R.id.tvIngresoNeto9);
        tvCasasCantidad = findViewById(R.id.tvCasasCantidad9);
        tvIngresosAntes = findViewById(R.id.tvIngresosAntes9);
        tvSaldoMesAnterior = findViewById(R.id.tvSaldoMesAnterior9);
        tvResiduosMes = findViewById(R.id.tvIngresoReciclaje9);

        mQueue = Volley.newRequestQueue(Transparencia9Activity.this);
        jsonParse2();
    ...
    private void eventos() {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Transparencia9Activity.this, Transparencia8Activity.class);
                startActivity(i);
                finish();
            }
        });
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Transparencia9Activity.this, Transparencia10Activity.class);
                startActivity(i);
                finish();
            }
        });
                        ...
                        try {
                            ...
                            for (int i = 0; i < tamRes2; i++) {
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent i = new Intent(Transparencia9Activity.this, MuestraFotoTransparencia.class);
