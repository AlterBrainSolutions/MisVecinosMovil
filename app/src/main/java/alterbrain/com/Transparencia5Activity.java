...
public class Transparencia5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvIngresosAntes = findViewById(R.id.tvIngresosAntes5);
        tvSaldoMesAnterior = findViewById(R.id.tvSaldoMesAnterior5);
        tvResiduosMes = findViewById(R.id.tvIngresoReciclaje5);
